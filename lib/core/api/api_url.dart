class ApiUrl {
  ...
  static String specializationShowUrl(int id) => "${baseUrl}specialization/show/$id";

  // ---------------- Doctor Module ----------------
  static const String doctorIndexUrl = "${baseUrl}doctor/index";
  static String doctorShowUrl(int id) => "${baseUrl}doctor/show/$id";
  static String doctorFilterUrl(int cityId) => "${baseUrl}doctor/doctor-filter?city=$cityId";
  static String doctorSearchUrl(String name) => "${baseUrl}doctor/doctor-search?name=$name";
